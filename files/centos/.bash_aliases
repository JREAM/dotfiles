...
#
# Suggested yum Packages: pydf colordiff nmap
...
alias yum-complete-transaction='sudo yum-complete-transaction'
alias yum-config-manager='sudo yum-config-manager'
alias yumdb='sudo yumdb'
alias yum-debug-dump='sudo yum-debug-dump'
alias yum-debug-restore='sudo yum-debug-restore'
alias yumdownloader='sudo yumdownloader'
alias yum-groups-manager='sudo yum-groups-manager'
...
alias updatey='sudo yum update && sudo yum upgrade -y'

alias autoremove='sudo yum autoremove && dnf autoremove'
alias autoclean='sudo yum clean && dnf clean'
