...
s0_put_left_key = <Alt><Super>Left
s0_put_left_button = Disabled
s0_put_right_key = <Alt><Super>Right
s0_put_right_button = Disabled
s0_put_top_key = <Alt><Super>Up
s0_put_top_button = Disabled
s0_put_bottom_key = <Alt><Super>Down
...
[core]
s0_active_plugins = core;composite;opengl;compiztoolbox;decor;vpswitch;snap;mousepoll;resize;place;move;wall;grid;regex;imgpng;session;gnomecompat;animation;fade;workarounds;scale;expo;ezoom;switcher;
